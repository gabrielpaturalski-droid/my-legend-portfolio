        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            <p className="text-muted-foreground text-lg leading-relaxed mb-6 font-body">
              Sou um profissional apaixonado por tecnologia e design, com mais de 10 anos
              de experiência criando soluções digitais inovadoras. Minha abordagem combina
              estética com funcionalidade para entregar resultados que superam expectativas.
            </p>
