      ...
      <div className="max-w-6xl mx-auto w-full grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="flex gap-4">
            <a
              href="#contato"
              className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-8 py-3.5 rounded-full font-body font-medium hover:opacity-90 transition-opacity"
            >
              Fale Comigo
            </a>
            <a
