        ...
        <motion.div
          ...
          <div className="w-9 h-9 rounded-full overflow-hidden shrink-0">
            <img
              ...
              alt="João Silva"
              className="w-full h-full object-cover" src="/lovable-uploads/160b0912-cbcc-4ad0-be85-7253d635ef03.webp" />
          ...
          <AnimatePresence mode="wait">
            ...
            <motion.span
              ...
              className="font-heading text-base font-semibold text-foreground pr-2 whitespace-nowrap overflow-hidden">Gabriel
